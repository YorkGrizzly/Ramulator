...
//config: config of type of memory, spec : type of memory
{
  ...
  for (int c = 0; c < C; c++)
  {
    //create channel, make controller for that channel
...
int main(int argc, const char *argv[])
{
  ...
  // make sure takes the argument ".trace", whether in specified output file mode or default mode (output to ".stats")
  int trace_start = 3;
  string stats_out;
